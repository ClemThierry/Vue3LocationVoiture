<template>
        <div class="pt-8 pb-8 flex max-w-xs mx-auto items-center justify-between">
            <a href="#" class="text-dark-blue hover:text-gray-800 dark:hover:text-white transition-colors duration-200">
