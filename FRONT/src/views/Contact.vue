<template>
  <div class="contact bg-contact-bg bg-cover bg-bottom min-h-screen grid grid-cols-2 content-center">
    <form class="flex w-full max-w-sm space-x-3 justify-self-center">
    <div class="w-full max-w-3xl px-5 py-10 m-auto mt-10 bg-white rounded-lg shadow dark:bg-gray-800">
